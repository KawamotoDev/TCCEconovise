    ...
    hover:shadow-md cursor-pointer h-[170px]'>
          ...
          <div className='mt-5'>
              <div className='flex items-center justify-between mb-3'>
                  <h2 className='text-xs text-slate-400'>R${budget.totalSpend?budget.totalSpend:0} Gasto</h2>
                  <h2 className='text-xs text-slate-400'>R${budget.amount-budget.totalSpend} Restante</h2>
